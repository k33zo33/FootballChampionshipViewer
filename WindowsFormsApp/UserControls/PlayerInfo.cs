    ...
    public partial class PlayerInfo : UserControl
    {
        ...
        private void SetData(StartingEleven player)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"An error occured while trying to set starting eleven player data:{ex.Message}");
        ...
        private void EditToolStripMenuItem_Click(object sender, System.EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"An error occured while saving the picture:{ex.Message}");
            }
        }
