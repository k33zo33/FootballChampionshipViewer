...
namespace WindowsFormsApp
{
    public partial class MainForm : Form
    {
        ...
        //private List<PlayerInfo> selectedPlayers = new List<PlayerInfo>();
        ...
        //private void PnlPlayersContainer_MouseDown(object sender, MouseEventArgs e)
        //{
        //    ctrlKeyPressed = (Control.ModifierKeys & Keys.Control) == Keys.Control;

        //    if (sender is PlayerInfo playerInfo)
        //    {
        //        if (ctrlKeyPressed)
        //        {
        //            // Toggle the selection state when Ctrl key is held down
        //            playerInfo.selected = !playerInfo.selected;

        //            if (playerInfo.selected)
        //            {
        //                selectedPlayers.Add(playerInfo);
        //            }
        //            else
        //            {
        //                selectedPlayers.Remove(playerInfo);
        //            }
        //        }
        //    }
        //}
        ...
        private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"An error occured while trying to print the document:{ex.Message}");
            }
        }
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"An error occured while trying to close the form:{ex.Message}");
            }
        }
